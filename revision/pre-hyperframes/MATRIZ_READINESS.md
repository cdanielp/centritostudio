...
PR, pendiente de merge. HyperFrames no iniciada; gate final pendiente.** Baseline de suite:
`2839 passed, 4 skipped` (4 skips = los cuatro históricos de symlink; incluye +183 de HF-1
y +38 de HF-2). Detalle y evidencia en `AUDITORIA.md` / `H1_EVIDENCIA.md` /
